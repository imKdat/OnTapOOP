...
public class Laptop {
    ...
    public void nhapTT() {
        ...
        System.out.println("Nhap ten laptop: ");sc.nextLine();
        tenLap = sc.nextLine();
        ...
        for(int i=0;i<ram.getSoThanh();i++){
        ...
        System.out.println("Do phan giai: ");
        ...
        if(chonC==1){
            oc.setLoaiOC("HDD");
            System.out.println("Nhap ma o cung: ");sc.nextLine();
            oc.setMaOC(sc.nextLine());
            System.out.println("Nhap dung luong: ");
            oc.setDungLuong(sc.nextInt());
            System.out.println("Nhap don gia: ");
            oc.setDonGia(sc.nextInt());
            System.out.println("Nhap toc do quay(rpm): ");sc.nextLine();
        ...
        if(chonC==2){
            ...
            System.out.println("Nhap don gia: ");
            oc.setDonGia(sc.nextInt());
            System.out.println("Nhap toc do doc(MB/s): ");sc.nextLine();
    ...
    public void inTT() {
        ...
        System.out.println("Man hinh: "+man.getMaMH()+" "+man.getDoPG()+" "+man.getDonGia()+" "+man.isDoChongLoa());
    }
